...
public class NoticeSound implements LineListener {
...
class NoticeSoundThread implements Runnable{
	String fileLocation;
	NoticeSound player;
	long delay;
	
	NoticeSoundThread(String location) {
		// TODO Auto-generated constructor stub
		this.fileLocation= location;
	}
	NoticeSoundThread(String location, long d) {
		// TODO Auto-generated constructor stub
		this.fileLocation=location;
		this.delay= d;
